// ============================================================
// 🚀 main.js - الخادم الشامل المتكامل (النسخة النهائية)
// ============================================================
...
(function(global) {
    ...
    const Channel = {
        ...
        sync: async function() {
            ...
            for (const file of result.files) {
                Repo.addFile(file.path, file.content, 'مزامنة من القناة');
                count++;
            }
    ...
    const TileServer = {
        ...
        // القناة
        channel: {
            sync: Channel.sync.bind(Channel),
    ...
    console.log(`📁 الملفات: ${Repo.getStats().files}`);
    console.log(`📝 الالتزامات: ${Repo.getStats().commits}`);
    ...
    console.log('  TileServer.channel.sync()   - سحب من القناة');
    ...
    console.log('  TileServer.logs.get()       - عرض السجلات');
