// ========== ناردو برو - النظام النهائي الكامل مع التاجر ==========
...
// ========== 17. إرسال إشعار للمدير عند تسجيل تاجر جديد ==========
...
// ========== 18. موافقة المدير على التاجر مع إشعار فوري ==========
...
// ========== 19. إرسال إشعار الموافقة للتاجر في تليجرام ==========
...
// ========== 20. التحقق من الإشعارات المعلقة عند تسجيل الدخول ==========
...
// ========== 23. استقبال الإشعارات من النوافذ الأخرى ==========
try {
